...
class SchedulerServiceTest {
    ...
    /**
     * Тестирование добавления отложенного повторяющегося задания в очередь заданий на выполнение
     */
    @Test
    ...
    /**
     * Тестирование удаления отложенного повторяющегося задания из очереди заданий на выполнение
     */
    @Test
