...
/**
 * Класс для тестирования класса {@link PreViewMuseumsRankCommand}
 */
...
class PreViewMuseumsRankCommandTest {
    ...
    void getMessage() {
        ...
        Message message = preViewMuseumsRankCommand.getMessage(commandArgs);
        ...
        assertEquals("GetRank", message.getButtonsContext().get().getCallbackData());
