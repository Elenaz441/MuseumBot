...
public class HelpCommand implements Command {
    ...
    private static final String HELP_MESSAGE = """
            ...
            \t/change_settings - Изменить настройки уведомлений.
            Также я могу присылать вам напоминание за день до мероприятия, информацию о случайном экспонате\040
            и предлагать пройти викторины после мероприятия.\040
            Вы можете настроить все эти функции с помощью команды /changeSettings.
